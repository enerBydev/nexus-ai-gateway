...
### Added
- Add queue depth limiting and backpressure headers (#59) (#145)
...
### Changed
- Deduplicate config parsing + add source attribution (#77, #70) (#144)
...
### Fixed
- Untrack developer tool artifacts and fix CLAUDE.md gitignore (#43)
...
### Fixed
- Per-model chunk timeout for silent thinking models (#79)
...
### Fixed
- Add first-byte timeout to bound stalled upstreams (#83)
